...
EmptyPage {
    ...
    contentItem: ListView {
        ...
        property int iconSize: kickoff.listIconSize
        ...
        implicitWidth: {
            ...
            if (root.mainContentView) {
                ...
                return (kickoff.gridIconSize + Global.gridCellSpacing) * kickoff.minGridRowCount + totalMargins
            }
        ...
        currentIndex: count > 0 ? root.defaultIndex : -1
        focus: true
        ...
        highlight: PExtras.Highlight {
            ...
            active: view.activeFocus || (kickoff.contentArea === root && kickoff.searchField.activeFocus)
        }

        delegate: KickoffListDelegate {
            width: view.availableWidth
            icon.width: view.iconSize
            icon.height: view.iconSize
        }
        ...
        spacing: root.isSidebar && !Plasmoid.configuration.isUpdateOnHover ? Kirigami.Units.smallSpacing : 0
        ...
        section {
            ...
            delegate: PExtras.ListSectionHeader {
                ...
                width: view.availableWidth
                height: Global.compactListDelegateHeight
        ...
        PComponents.ScrollBar.vertical: PComponents.ScrollBar {
        ...
        Connections {
            ...
            function onExpandedChanged() {
                if (kickoff.expanded) {
                    view.currentIndex = root.defaultIndex
