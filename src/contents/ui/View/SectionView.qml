...
KickoffGridView {
    ...
    view.cellWidth: Math.floor((view.implicitWidth - view.leftMargin - view.rightMargin) / (kickoff.minGridRowCount * 1.75))
    view.cellHeight: view.cellWidth

    delegate: PComponents.AbstractButton {
        id: delegate
